...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        orgID = tk.Label(self.window, text="Org ID", width=10, height=2, fg="white", bg="#363e75", font=('times', 15))
        orgID.place(x=80, y=80)

        displayVariable = StringVar()
        self.orgIDTxt = tk.Entry(self.window, width=20, text=displayVariable, bg="white", fg="black",
                               font=('times', 15, 'bold'))
        self.orgIDTxt.place(x=205, y=80)

        stuID = tk.Label(self.window, text="Stu_ID", width=10, fg="white", bg="#363e75", height=2, font=('times', 15))
        stuID.place(x=450, y=80)

        self.stuIDTxt = tk.Entry(self.window, width=20, bg="white", fg="black", font=('times', 15, ' bold '))
        self.stuIDTxt.place(x=575, y=80)
        ...
        # link2.pack()
        link2.bind("<Button-1>", lambda e: self.callback("123"))
    ...
    def collectUserImageForRegistration(self):
        orgIDVal = (self.orgIDTxt.get())
        stuIDVal = self.stuIDTxt.get()
